...
//    console.log(nodes.length);
    ...
    var xpaths_template = {
      'url' : prefix + '/div/div/div[@class="database_entry_title"]/a/@href',
      'thumb' : prefix + '/div[@class="database_entry_image"]/a/img/@src',


//      'species' : '//results/div[contains(@class,"database_entry")][%s]/div[@class="matrix_entry_title"]/a/text()',
...
//  'plantTypes' : '//div[@class="database_entry_property"]/span/text()[contains(.,"Plant Type")]/../../text()',
    ...
    nodes.map(function(current, index, array) {
      ...
      for (var template in xpaths_template) {
         xpaths[template] = util.format(xpaths_template[template],bar);
      }
